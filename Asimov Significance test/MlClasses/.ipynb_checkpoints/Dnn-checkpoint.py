...
class Dnn(object):
    ...
    def setup(self,hiddenLayers=[1.0],dropOut=None,l2Regularization=None,loss=None, activation='relu',optimizer='adam' ,extraMetrics=[]):
        ...
        for name,val in self.defaultParams.items():
    ...
    def makeHepPlots(self,expectedSignal,expectedBackground,systematics=[0.0001],makeHistograms=True,subDir=None,customPrediction=None):
        ...
        #dataTest.to_csv('data_asiSigLoss_TC_ZH_0L_cHW_0d03.csv',sep=' ')
